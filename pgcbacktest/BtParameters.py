...
def get_parameter_data(code, parameter_path):
    ...
    elif (code == 'DT') or (code == 'DT_SI') or (code == 'DT_RE') or (code =='DT_TRAIL') or (code == 'DTN') or (code == 'DTB_RE') or (code == 'DTW') or (code == 'DT_FS'):
        # filter - where sl = 0
        parameter.loc[parameter['sl'] == 0, 'method'] = 'HL'
    ...
    elif (code == 'NRE') or (code == 'NREW') or (code == 'NRE_SI') or (code == 'NRE_CC') or (code == 'NREW_CC') or (code == 'NRE_CC_RE_TillTime') or (code == 'NRE_CC_TRAIL') or (code == 'NRE_CC_TARGET'):
        # filter - where sl = 0
        parameter.loc[parameter['sl'] == 0, 'method'] = 'HL'
